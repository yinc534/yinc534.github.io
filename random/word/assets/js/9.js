...
var words = ['according', 'important', 'different', 'scientist', 'thousands', 'paragraph', 'represent'];
...
if ($("input").val() == words[current_word]) {
    ...
    $("div.jumbled-word").slideUp(300, function() {
        current_word++;
